...
## Arquitetura de Dados, Proveniência e Governança
...
# =====================================================================
cells.append(md("""# Implementação Acadêmica e Motores Equivalentes
...
# Salvar em scripts/notebooks e notebooks
base_dir = os.path.dirname(os.path.dirname(__file__))
for subdir in ["scripts/notebooks", "notebooks"]:
